    ...
    resources: {
        ...
        applications: {
            ...
            fields: {
                ...
                deferredClientId:
                    'La identificación del cliente estará disponible después del registro.',
            ...
            validation: {
                ...
                clientDefintion_json:
                    'Se requiere json válido, 5000 como máximo.',
            },
            status: {
                enabled: 'Activado',
                disabled: 'Desactivado',
        ...
        apikeys: {
            ...
            replace_client_metadata_content:
                'Los cambios en los metadatos del cliente se perderán con esta acción. ¿Estás seguro de que quieres continuar?',
            client_metadata_accordion_title: 'Metadatos del cliente',
            reg_pending_title: 'Inscripción pendiente',
            reg_pending_wf_content:
                'El OAuth Client se encuentra en estado de registro pendiente. Se puede enviar al proveedor de autenticación para su creación una vez que se apruebe la solicitud del OAuth Client.',
            reg_pending_incomplete_content:
                'El OAuth Client se encuentra en estado de registro pendiente. Se puede enviar al proveedor de autenticación para su creación una vez que se publique la aplicación.',
            actions: {
                ...
                replace_client_metadata_dialog_submit:
                    'Reemplazar metadatos del cliente',
                cancel: 'Cancelar',
                delete: 'Eliminar',
                close: 'Cerrar',
            },
